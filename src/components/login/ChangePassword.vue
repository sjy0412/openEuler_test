<template>
	<div class="login-form">
		<el-form :model="formData" :rules="rules" ref="formData" status-icon class="demo-ruleForm">
          ...
          class="password"
           ...
           class="password"
			...
			<el-form-item>
				<el-button type="default" class="cancel-btn" @click="handleCancel()">取消</el-button>
				<el-button type="primary" class="sure-btn" @click="changeSubmit('ruleForm')">提交</el-button>
			</el-form-item>
		</el-form>
	</div>
</template>
...
::v-deep .el-icon-circle-close:before {
  content: url('@/assets/login/error.svg')
}
</style>
